...
int k = 200;					// spring constant of the spring used for the force sensor
...
int eXb = 1;				// distance assosiated with point b of pot used for the force sensor
							// of the eraser, in inches
int ibTL = 109;				// analog read of the top left foot at the extent, point b
int ibTR = 110;				// analog read of the top right foot at the extent, point b
int ibBL = 120;				// analog read of the bottom left foot at the extent, point b
int ibBR = 112;				// analog read of the bottom right foot at the extent, point b
...
int hookspeed = 30;			//speed the hook's motor turns
int front_rail_switch = 13;	//pin number of the front rail limit switch
int back_rail_switch = 14;	//pin number of the back rail limit switch
